...
import com.example.androidtestproject.databinding.ActivityLearnBroadcastReceiverBinding
...
//            abortBroadcast()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intentFilter1 = IntentFilter("com.example.androidtestproject.MyBroadCastAction")
        intentFilter1.priority = 1 // higher priority number will be called first
        registerReceiver(broadCastReceiver1, intentFilter1)

        val intentFilter2 = IntentFilter("com.example.androidtestproject.MyBroadCastAction")
        ...
        binding.btnStartOrderedBroadcast.setOnClickListener {
            ...
            val intent = Intent("com.example.androidtestproject.MyBroadCastAction")
        ...
        binding.btnStartPermissionBroadcast.setOnClickListener {
            val intent = Intent("com.example.androidtestproject.PermissionBroadCastAction")
    ...
    override fun onStart() {
        ...
        val intentFilterPermission = IntentFilter("com.example.androidtestproject.PermissionBroadCastAction")
