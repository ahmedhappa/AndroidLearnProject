...
import com.example.androidtestproject.databinding.ActivityLearnNotificationBinding
...
class LearnNotificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnShowNotification.setOnClickListener {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O
                && isNotificationChannelBlocked(AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
            ) {
                openChannelSetting(AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
                return@setOnClickListener
            }
        ...
        binding.btnDeleteNotificationChannel.setOnClickListener {
            ...
            so there is no reason to delete and create channel for resting it 's properties */
                notificationManager.deleteNotificationChannel(AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID3)
                //we can also delete a notification channel group
                notificationManager.deleteNotificationChannelGroup(AndroidTestProjectApp.NOTIFICATION_CHANNEL_GROUP_ID1)
            }
        }
    ...
    private fun buildNormalNotification(): NotificationCompat.Builder {
        ...
        return NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
...
//            this flag is to not update intent when new notification triggers
    ...
    companion object {
        ...
        fun buildMessageStyleNotification(context: Context): NotificationCompat.Builder {
            ...
            return NotificationCompat.Builder(context, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
    ...
    private fun showProgressNotification() {
        ...
        val notification = NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
    ...
    private fun groupNotification() {
        ...
        val notification1 = NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
        ...
        val notification2 = NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
        ...
        val summaryNotification = NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
        ...
        val notification3 = NotificationCompat.Builder(this, AndroidTestProjectApp.NOTIFICATION_CHANNEL_ID)
