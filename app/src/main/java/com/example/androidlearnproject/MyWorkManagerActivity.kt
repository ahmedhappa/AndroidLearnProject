...
import com.example.androidlearnproject.MyWorkManagerActivity.Companion.passedDataKey
import com.example.androidlearnproject.databinding.ActivityMyWorkManagerBinding
...
class ForegroundWorkManager(private val appContext: Context, workerParameters: WorkerParameters) :
    ...
    private fun createForegroundNotification(): Notification {
        return NotificationCompat.Builder(appContext, AndroidLearnProjectApp.NOTIFICATION_CHANNEL_ID)
